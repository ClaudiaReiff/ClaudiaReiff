...
<div style="padding-right: 40px;padding-left: 40px;margin-top: 20px">
  <div style="display: flex;height: 350px">
    ...
    <div style="width: 35%;height: 100%">
      <div style="background-image: url('img/background.png');height: 50%;margin-left: 10px;border-radius: 10px"></div>
      <div style="display: flex;height: 50%;margin-left: 10px">
        <div style="background-image: url('img/background.png');width: 100%;margin-right: 10px;margin-top: 10px;border-radius: 10px"></div>
        <div style="background-image: url('img/background.png');width: 100%;margin-top: 10px;border-radius: 10px"></div>
      </div>
    </div>
  </div>
  ...
  <div style="display: flex;height: 50px">
    <div style="width: 70%">
      <div style="font-size: 36px;font-weight: bold;color: black;margin-top: 20px">Ferienwohnung</div>
    ...
    <div style="width: 30%;height: 200px;" class="cookie-card"></div>
  </div>
</div>
</body>
